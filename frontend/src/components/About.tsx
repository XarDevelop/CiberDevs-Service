        ...
        <div className="container">
            <div className="about-grid">
                <div className="about-content">
                    <span className="section-label">Sobre CiberDev</span>
                    ...
                    <ul className="contact-list">
                        ...
                        <li className="contact-item">
                            ...
                            <div className="contact-details">
                                ...
                                <p>francislopez0507@gmail.com</p>
                            </div>
                        </li>
                        <li className="contact-item">
                            <div className="contact-icon">📍</div>
                ...
                <div className="about-visual">
                    <div className="about-image">
                        ...
                        <div className="social-links">
                            ...
                            <a href="#" className="social-link" title="X (Twitter)" aria-label="X (Twitter)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            </a>
                            <a href="https://wa.me/51366196" className="social-link" title="WhatsApp" aria-label="WhatsApp">
