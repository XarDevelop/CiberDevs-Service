        ...
        <div className="container">
            ...
            <div className="faq-list">
                <div className={`faq-item${openItems.has(0) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(0)} aria-expanded={openItems.has(0)}>
                ...
                <div className={`faq-item${openItems.has(1) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(1)} aria-expanded={openItems.has(1)}>
                ...
                <div className={`faq-item${openItems.has(2) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(2)} aria-expanded={openItems.has(2)}>
                ...
                <div className={`faq-item${openItems.has(3) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(3)} aria-expanded={openItems.has(3)}>
                ...
                <div className={`faq-item${openItems.has(4) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(4)} aria-expanded={openItems.has(4)}>
                ...
                <div className={`faq-item${openItems.has(5) ? ' active' : ''}`}>
                    <button className="faq-question" onClick={() => toggleItem(5)} aria-expanded={openItems.has(5)}>
